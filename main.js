...
function runTheFishApp(allFishData){
  ...
  $(document).on('change', '.fish', function () {
    ...
    var selectedFishDataPAIRING = $("#fishList input:checkbox:checked").map(function(){
      return $(this).data("index");
    }).get();

    // THESE ARE YOUR FISHES!!!!!
    console.log("These are your returned fishes", returnSelectedFishData(selectedFishDataPAIRING))
